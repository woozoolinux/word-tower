  ...
  function unlock(o, done) {
    ...
    root.innerHTML = `
      ...
      <div class="fx-stage">
        ...
        <div class="fx-code">${levelCode(o.next) || esc(o.next.name)}</div>
        <div class="fx-big">${p.big}</div>
        <div class="fx-praise">${esc(p.sub).replace(/\n/g, '<br>')}</div>
        <div class="fx-stat">${levelCode(o.king)} ${o.king.emoji} ${esc(o.king.name)}의 단어 <b>${o.words}개</b>를 전부 상대했다</div>
        <div class="fx-chips">
